...
def main(page) :
    ...
    def get_match_info(championships):
        ...
        for i in range(number_of_matches):
            ...
            matches_details.append({"نوع البطوله":championship_title,
                                    "الفريق الاول":team_A,"الفريق الثاني":team_B,"موعد المباراه":match_time,
                                    "النتيجة":score})
    ...
    with open(r'C:\Users\Administrator\OneDrive - Enterprise\Desktop\Matches.csv', newline='', encoding='utf-8-sig', mode='w') as output_file:
